...
class preprocesses:
    ...
    def collect_data(self):
        ...
        print("Creating preprocess folder at "  + output_dir)
        os.mkdir(output_dir)
                ...
                for image_path in cls.image_paths:
                    ...
                    if not os.path.exists(output_filename):
                        try:
                            ...
                            img = np.asarray(imageio.imread(image_path)) 
...
def startPreprocessing(trainFolder, preprocessFolder):

    if not hasattr(sys, 'argv'):
        sys.argv  = ['']
    sys.path.append('.')

    obj = preprocesses(trainFolder,preprocessFolder)
